...
using MiraUtils.Client.Extensions;
using System;
...
namespace MiraUtils.Controls.FileExplorer
{
    public partial class frmFileExplorer : DockContent, IMiraControl
    {
        ...
        private void PopulateNode(PbConnection p_Connection, TreeNode p_Parent, string p_Path)
        {
        ...
        private void tvExplorer_BeforeExpand(object p_Sender, TreeViewCancelEventArgs p_Args)
        {
            ...
            if (s_Node.Tag is PbConnection)
            {
                PopulateNode(s_Node.Tag as PbConnection, s_Node, "/");
            }
        ...
        private PbConnection GetNodeConnection(TreeNode p_Node)
        {
            var s_Current = p_Node;
            while (s_Current != null)
            {
                var s_Dent = s_Current.Tag as PbConnection;
                if (s_Dent == null)
                {
                    s_Current = s_Current.Parent;
                    continue;
                ...
                return s_Current.Tag as PbConnection;
            }
        ...
        private void RecursiveDownload(PbConnection p_Connection, string p_LocalDir, string p_RemoteDir, bool p_Overwrite = true)
        {
