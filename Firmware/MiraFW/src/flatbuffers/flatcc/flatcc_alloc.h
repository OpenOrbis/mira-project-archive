...
#ifndef FLATCC_ALLOC
#define FLATCC_ALLOC(n) k_malloc(n)
 //malloc(n)
#endif

#ifndef FLATCC_FREE
#define FLATCC_FREE(p) k_free(p)
//free(p)
#endif

#ifndef FLATCC_REALLOC
#define FLATCC_REALLOC(p, n) k_realloc(p, n)
//realloc(p, n)
#endif

#ifndef FLATCC_CALLOC
#define FLATCC_CALLOC(nm, n) k_calloc(nm, n)
#endif
...
#ifndef FLATCC_ALIGNED_ALLOC
//aligned_alloc(a, n)
#define FLATCC_ALIGNED_ALLOC(a, n) k_malloc(n)
#endif

#ifndef FLATCC_ALIGNED_FREE
// aligned_free(p)
#define FLATCC_ALIGNED_FREE(p) k_free(p)
#endif
