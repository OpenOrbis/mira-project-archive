...
#define print_hex_float(n, p) int(*sprintf)(char *str, const char *format, ...) = kdlsym(sprintf); sprintf(p, "%a", (float)(n))

#define print_hex_double(n, p) int(*sprintf)(char *str, const char *format, ...) = kdlsym(sprintf); sprintf(p, "%a", (double)(n))
